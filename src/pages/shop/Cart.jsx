...
import { Col, Row, Table, Tbody, Thead } from "../../components/Table";
        ...
        <div className="flex space-x-3">
            <div className=" w-96">
                <div className="rounded-xl p-2 bg-base-200">
                    ...
                    <div>
                        <Link to={"../invoice"}><button type="button" className="btn btn-primary">مرحله بعدی</button></Link>
                    </div>
                </div>
            </div>
            <div className="w-full bg-base-200 rounded-xl p-1">
                <Table>
                    ...
                    <Tbody>
                        <Row>
                            <Col>1</Col>
                            <Col>قاب 12 pro max</Col>
                            <Col>1</Col>
                            <Col>169,000 تومان</Col>
                            <Col>
