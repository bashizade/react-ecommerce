const Footer = () => {
    return (
        <>
            <footer className="footer p-10 bg-base-300 text-base-content rounded-tr-xl rounded-tl-xl">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t border-base-200 bg-base-300 text-base-content rounded-br-xl rounded-bl-xl">
